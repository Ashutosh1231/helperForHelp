    ...
    <div class="relative p-4 w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                ...
                <a href="#" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"  data-modal-hide="add-customer-modal">
            ...
            <div class="w-full p-4 md:p-5">
                <form name="add-customer-manager-modal" id="add-customer-manager-modal" class="space-y-4" action="customer_save.php" method="POST">
                    <input type='hidden' id='customer_id' name='customer_id'></input>
                    <input type="hidden" id="customer_action" name="action" value="addcustomer" />
                    ...
                    <div class='flex mb-2 w-full'>
                        ...
                        <div class='flex flex-row w-1/2  mx-2'>
                            ...
                            <input id='male' name='gender' value='Male' type='radio' class='mt-7' />
                            <label class='mt-6 mx-2' for='male'>Male</label><br/>
                            <input id='female' name='gender' value='Female' type='radio' class='mt-7' />
                            <label class='mt-6 mx-2' for='female'>Female</label>
                        </div>
                    </div>
