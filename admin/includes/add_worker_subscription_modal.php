<!-- Main modal -->
<div id="add-worker-subscription-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                <h3 class="text-xl font-semibold text-gray-900 ">
                    Add/Edit Worker Subscription Plan
                </h3>
                <a href="#" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"  data-modal-hide="add-worker-subscription-modal">
            ...
            <div class="p-4 md:p-5">
                <form name="add-worker-subscription" id="add-worker-subscription" class="space-y-4" action="worker_subscription_plan_save.php" method="POST">
